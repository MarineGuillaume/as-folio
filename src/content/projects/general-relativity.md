---
title: "Diplomatie numérique : enjeux et défis pour l'Union Européenne"
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img src="/assets/img/6.jpg" class="img-fluid rounded z-depth-1" alt="Spacetime curvature" loading="lazy" />
    </div>
    <div class="col-sm mt-3 mt-md-0">
        <img src="/assets/img/11.jpg" class="img-fluid rounded z-depth-1" alt="Gravitational lensing" loading="lazy" />
    </div>
</div>
<div class="caption">
    Illustrations of spacetime curvature caused by massive objects and the gravitational lensing effects predicted by General Relativity.
</div>
